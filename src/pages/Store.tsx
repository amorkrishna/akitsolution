  ...
  return (
    <div className={`min-h-screen ${bg} ${textPrimary} transition-colors duration-300 overflow-x-hidden`}>
      <SEOHead
        ...
        type="website"
        keywords="CCTV camera service in Dhaka, CCTV installation near me, Best CCTV camera provider in Dhaka, CCTV camera installation price in Bangladesh, CCTV technician in Dhaka, Security camera installation Dhaka, CCTV repair service Dhaka, IP camera installation service Dhaka, Hikvision CCTV camera setup Dhaka, Dahua CCTV camera price in BD, Uniview/Jovision camera installation Dhaka, 8 camera CCTV package price in Bangladesh, 4 camera CCTV full setup price BD, Wireless IP camera service Dhaka, Office security system installation Dhaka, ঢাকায় সিসিটিভি ক্যামেরা সার্ভিস, সিসিটিভি ক্যামেরা ফিটিং খরচ, সিসিটিভি ক্যামেরা টেকনিশিয়ান ঢাকা, বাসার জন্য ভালো সিসিটিভি ক্যামেরা, দোকানের সিসিটিভি ক্যামেরা সেটআপ, সিসিটিভি ক্যামেরা মেরামত ঢাকা, কম দামে সিসিটিভি ক্যামেরা প্যাকেজ, CCTV camera laganor khoroch, Dhaka cctv camera fitting service, Kom dame cctv camera package, CCTV camera technician dhaka, Bashar jonne bhalo cctv camera, Shop er cctv camera setup price, CCTV installation in Mirpur, CCTV service in Uttara, Motijheel security system technician, CCTV camera price in Bangladesh, CCTV installation service Bangladesh, সিসিটিভি ক্যামেরা ইনস্টলেশন বাংলাদেশ, network setup service Bangladesh, CCTV camera Dhaka, CCTV installation service Dhaka, Best CCTV camera installation in Dhaka, Top IT company in Motijheel, CC camera setup near Gulshan, Network installation service Banani, CCTV repair in Uttara, IT support service Dhanmondi, Attendance machine setup Mirpur, Server configuration Dhaka BD, CCTV dealer in Elephant Road, Network cabling service in Mohakhali, IP camera shop in Badda, Office IT setup in Karwan Bazar, Hikvision CCTV camera price BD, Dahua CC camera price Bangladesh, IP camera price in Bangladesh, WiFi CC camera price BD, DVR price in Bangladesh, NVR price BD, networking equipment price Bangladesh, router price BD, attendance machine price Bangladesh, ZKTeco attendance machine price, IT solutions company Bangladesh, server setup Bangladesh, IT support service Bangladesh, AK IT Solution, ICT Bhaban Dhaka, সিসি ক্যামেরা দাম, সিসিটিভি লাগাতে কত খরচ, আইটি সাপোর্ট, ফিঙ্গারপ্রিন্ট এটেন্ডেন্স মেশিন, cc camera lagano, cctv lagate koto khoroch, cc cemera, cc camra dhaka, netwok setup, attendence mechine, finger print mechine, router configure kora, rutar setup, compoter repair, leptop thik kora, it sopport, cctv pakaege dhaka, cc camera dam koto bd, dahua kemera, hekvision cemera, tplink rutar, basa barite cctv lagabo, dokane cctv lagano, mikrotik setup dhaka, lan cable tanano, pabx setup dhaka, intercom lagano, cctv banani, mirpur cctv repair, uttara cctv setup, motijheel network setup, wifi range extender setup, router password reset, server rack wiring, সিসি ক্যামেরায় রেকর্ডিং হচ্ছে না, cc camera recording problem, dvr nosto, nvr setup, ptz camera price bd, 360 camera lagano, sosti cc camera, v380 wifi camera dhaka, hikvison, hek vision, hk vision, dhua, dohua, dowa camera, tentda router, zkteko, zk teko, jk teco, jk teko, computer nosto, laptop on hoy na, cctv camera shop near me, it market dhaka, elephant road cctv, idb bhaban cctv camera"
      />
